...
describe 'LDP Test Suite', integration: true do
  before(:all) do
    ...
    LdpTestsuiteWrapper.default_instance_options[:url] = 'https://github.com/cbeer/ldp-testsuite/archive/master.zip'
    LdpTestsuiteWrapper.default_instance_options[:zip_root_directory] = 'ldp-testsuite-master'

    @server = Capybara::Discoball::Runner.new(Derby::Server).boot
